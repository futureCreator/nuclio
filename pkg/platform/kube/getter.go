...
func (g *getter) get(consumer *consumer, getFunctionsOptions *platform.GetFunctionsOptions) ([]platform.Function, error) {
	...
	if getFunctionsOptions.Name != "" {
		...
		function, err := client.NuclioV1beta1().NuclioFunctions(getFunctionsOptions.Namespace).Get(getFunctionsOptions.Name, metav1.GetOptions{})
		if err != nil {
		...
		functionInstanceList, err := client.NuclioV1beta1().NuclioFunctions(getFunctionsOptions.Namespace).List(metav1.ListOptions{LabelSelector: getFunctionsOptions.Labels})
